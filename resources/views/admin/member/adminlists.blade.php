...
@section('content')
    <div class="row text-white col-10 offset-1 mt-5">
        <h3 class="text-center mb-5">Admin lists</h3>
        <div class="d-flex justify-content-between">
            <h5 class="mb-3 ps-0">Total Admins - {{$adminlists->count()}}</h5>
            <div class="mb-3 ">
                <form action="{{route('admin#adminlistPage')}}" class=" d-flex"  method="GET">
                    @csrf
        ...
        @foreach ($adminlists as $key=>$item)
